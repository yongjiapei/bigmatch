...
(function(t, i, s) {
	...
	l.prototype = {
		...
		render: function() {
			var t = '<div class="ui-slider-wrap">' + '<div class="ui-slider-text ui-slider-no-select asa">' +'<i>' + this.opts.textMsg + '</i>' + "</div>" + '<div class="ui-slider-btn init ui-slider-no-select"></div>' + '<div class="ui-slider-bg"><i>验证通过</i></div>' + "</div>";
			this.ele.html(t);
			this.initStatus()
		},
		initStatus: function() {
